...
def new_conv_layer(input,  # The previous layer.
                   ...
                   num_filters,
                   padding='SAME',
                   use_relu=False):  # Number of filters.
...
class Model:
    ...
    def load_images(self, image_paths):
        ...
        images = [cv2.resize(cv2.imread(path, 1), (self.img_size, self.img_size)) for path in image_paths]
        ...
        with tf.Session() as sess:
            ...
            for i in range(total_iterations,
                ...
                if i % 500 == 0:
                    ...
                    saver.save(sess,
                               os.path.join(self.save_folder, 'model'))  # Change this according to your convenience
...
def parse_arguments():
    ...
    parser.add_argument('--iter', dest='num_iterations', type=int, default=15)
